...
library(tidyverse)
readxl::read_excel("/Users/harshvardhan/Dropbox/personal-website/content/notes/2022-11-22-coffee/ratings.xlsx") %>% 
  DT::datatable(rownames = FALSE)
#  mutate(Rating = color_tile("transparent", "lightpink")(Rating)) %>% 
#  kable("html") %>%
